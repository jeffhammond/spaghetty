...
for transpose_order in transpose_list:
    ...
    source_file.write('        call hpm_start("tce_sort_4_omp_flop #1")\n')
    ...
    source_file.write('        call hpm_stop("tce_sort_4_omp_flop #1")\n')
    ...
    source_file.write('        enddo \n')
    # END CACHE FLUSH
    source_file.write('        call hpm_start("tce_sort_4_omp_flop #2")\n')
    source_file.write('        Tstart='+timer_call+'\n')
    source_file.write('          CALL tce_sort_4_ompf(before, after_hirata,\n')
    source_file.write('     &                    aSize(1), aSize(2), aSize(3), aSize(4),\n')
    source_file.write('     &                    perm(1), perm(2), perm(3), perm(4),factor)\n')
    source_file.write('        Tfinish='+timer_call+'\n')
    source_file.write('        call hpm_stop("tce_sort_4_omp_flop #2")\n')
