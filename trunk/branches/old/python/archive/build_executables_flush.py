...
fortran_link_flags = '-O3 -qnoipa -qarch=450d -qtune=450 -qmaxmem=-1 -qextname -qreport=hotlist'
...
for transpose_order in transpose_list:
    ...
    source_file.write('        do i=1,'+flush_rank+'\n')
    source_file.write('          do j=1,'+flush_rank+'\n')
    ...
    source_file.write('        Thirata2=(Tfinish-Tstart)\n')
