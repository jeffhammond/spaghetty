...
fortran_opt_flags = '-O5 -qnoipa -qarch=450d -qtune=450 -qprefetch -qunroll=yes -qmaxmem=-1 -qalias=noaryovrlp:nopteovrlp -qreport=hotlist'
src_dir = '/gpfs/home/jhammond/spaghetty/python/archive/src/'
lst_dir = '/gpfs/home/jhammond/spaghetty/python/archive/lst/'
asm_dir = '/gpfs/home/jhammond/spaghetty/python/archive/asm/'
...
for transpose_order in transpose_list:
    ...
    for loop_order in loop_list:
        ...
        source_file.close()
        print fortran_compiler+' '+fortran_opt_flags+' -S '+source_name
        os.system(fortran_compiler+' '+fortran_opt_flags+' -S '+source_name)
        os.system('mv '+subroutine_name+'.F '+src_dir)
        os.system('mv '+subroutine_name+'.lst '+lst_dir)
        os.system('mv '+subroutine_name+'.s '+asm_dir)
