...
fortran_link_flags = '-g -O3 -xSSE2,SSE3,SSSE3,SSE4.1,SSE4.2 -opt-prefetch -static -funroll-loops'

c_compiler = 'icc'
c_opt_flags = '-g -O3 -xSSE2,SSE3,SSSE3,SSE4.1,SSE4.2 -opt-prefetch -static -funroll-loops -c'

src_dir = '/fusion/home/jhammond/spaghetty/python/archive/src/'
lst_dir = '/fusion/home/jhammond/spaghetty/python/archive/lst/'
...
print fortran_compiler+' '+fortran_opt_flags+' -c tce_sort_hirata_openmp_flop.F'
os.system(fortran_compiler+' '+fortran_opt_flags+' -c tce_sort_hirata_openmp_flop.F')
os.system('ar -r '+lib_name+' tce_sort_hirata_openmp_flop.o')
...
for transpose_order in transpose_list:
    ...
    C = transpose_order[2]
    D = transpose_order[3]
    driver_name = 'transpose_'+A+B+C+D+'superflush_omp_flop'
    print driver_name
    ...
    source_file.write('          CALL tce_sort_4_ompf(before, after_hirata,\n')
    ...
    source_file.write('        write(6,*) "==================="\n')
    source_file.write('        write(6,*) "Hirata OpenMP (flop) Ref. #1 = ",Thirata,"seconds"\n')
    ...
    for loop_order in loop_list:
        ...
        c = loop_order[2]
        d = loop_order[3]
        subroutine_name = 'trans_'+A+B+C+D+'_loop_'+a+b+c+d+'_ompf'
        # THIS PART FLUSHES THE CACHE
        source_file.write('        do ii=1,'+flush_rank+'\n')
        source_file.write('          do jj=1,'+flush_rank+'\n')
        source_file.write('            X(jj,ii) = 1d0/(ii+jj)\n')
    ...
    source_file.write('        write(6,*) "Hirata OpenMP (flop) Ref. #2 = ",Thirata2,"seconds"\n')
