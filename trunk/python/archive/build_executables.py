...
os.system('ar -r tce_sort_jeff_new.a tce_sort_hirata.o')
...
for transpose_order in transpose_list:
    ...
    source_file.write(' 1020 format(1x,a30,4i1)\n')
    source_file.write(' 1030 format(1x,a30,1f12.5)\n')
    source_file.write(' 1100 format(1x,a16,4f12.5)\n')
    source_file.write('      END\n')
    source_file.close()
    print fortran_compiler+' '+fortran_link_flags+' '+' '+source_name+' tce_sort_jeff_new.a '+' -o '+exe_dir+driver_name+'.x'
    os.system(fortran_compiler+' '+fortran_link_flags+' '+' '+source_name+' tce_sort_jeff_new.a '+' -o '+exe_dir+driver_name+'.x')
