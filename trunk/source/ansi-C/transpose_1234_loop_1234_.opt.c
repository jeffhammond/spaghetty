...
for (c1=0;c1<=dim1-1;c1++) {
  ...
  for (c4 = 0; c4 <= dim4 - 1 - 3; c4 = c4 + 4) {
      ...
      {old_offset=dim4*(dim3*(dim2*(c1)+c2)+c3)+(c4 + 1);};
      {new_offset=dim4*(dim3*(dim2*(c1)+c2)+c3)+(c4 + 1);};
      {sorted[((int)floor(new_offset))]=unsorted[((int)floor(old_offset))]*factor;};
      {old_offset=dim4*(dim3*(dim2*(c1)+c2)+c3)+(c4 + 2);};
      {new_offset=dim4*(dim3*(dim2*(c1)+c2)+c3)+(c4 + 2);};
      {sorted[((int)floor(new_offset))]=unsorted[((int)floor(old_offset))]*factor;};
      {old_offset=dim4*(dim3*(dim2*(c1)+c2)+c3)+(c4 + 3);};
      {new_offset=dim4*(dim3*(dim2*(c1)+c2)+c3)+(c4 + 3);};
      {sorted[((int)floor(new_offset))]=unsorted[((int)floor(old_offset))]*factor;};
    }
  for (; c4 <= dim4 - 1; c4 = c4 + 1) {
      {old_offset=dim4*(dim3*(dim2*(c1)+c2)+c3)+c4;};
      {new_offset=dim4*(dim3*(dim2*(c1)+c2)+c3)+c4;};
      {sorted[((int)floor(new_offset))]=unsorted[((int)floor(old_offset))]*factor;};
    }
